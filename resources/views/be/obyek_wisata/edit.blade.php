            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('obyek_wisata.update', $obyekWisata->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                    ...
                    <a href="{{ route('obyek_wisata.manage') }}" class="btn btn-light">Batal</a>
                    </form>
                </div>
            </div>
        </div>
