...
class PenginapanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('penginapan.manage')->with('success', 'Penginapan created successfully.');
    }
    ...
    public function update(Request $request, Penginapan $penginapan)
    {
        ...
        return redirect()->route('penginapan.manage')->with('success', 'Data penginapan berhasil diperbarui.');
    }

    public function destroy(Penginapan $penginapan)
    {
        $penginapan->delete();
        return redirect()->route('penginapan.manage')->with('success', 'Penginapan deleted successfully.');
    }
